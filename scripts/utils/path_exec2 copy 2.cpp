...
public:
    ...
    void update(const ros::TimerEvent &event)
    {
        ...
        tf2::angleShortestPath(setPoint.orientation, setPoint.orientation);
        ...
        vel_req.twist.linear.x = 0 * err_x;
        vel_req.twist.linear.y = 0 * err_y;
        vel_req.twist.linear.z = 0 * err_z;
